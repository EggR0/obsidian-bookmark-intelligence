...
- `manifest.json` version is `0.2.28`.
- GitHub release tag `0.2.28` must contain `main.js`, `manifest.json`, and `styles.css`.
- The browser/native-agent release tag `v0.2.28` remains separate from the Obsidian plugin release.
...
6. Confirm that the release tag exactly matches `manifest.json` version: `0.2.28`.
